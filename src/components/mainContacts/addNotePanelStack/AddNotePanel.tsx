...
export const AddNotePanel: React.FunctionComponent<Props> = ({ }) => {
    ...
    return (
        <StyledPanelContainer>
            <StyledTitleDiv>
                <StyledIcon onClick={() => dispatch(navigationSlice.actions.setAddNotePanelDialogOpen(false))} icon="cross" intent="primary" size={24} />
                <StyledTitleText>
                    Add Note
                </StyledTitleText>
            </StyledTitleDiv>
