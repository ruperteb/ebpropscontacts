...
import { collection, query, where, onSnapshot, getFirestore, DocumentData, addDoc } from "firebase/firestore";
...
export const AddManualPanel: React.FunctionComponent<Props> = ({ }) => {
    ...
    return (
        <StyledPanelContainer ref={containerRef} id="addmanualpanel">
            <StyledTitleDiv>
